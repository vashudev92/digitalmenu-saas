...
export default function DashboardSidebar() {
  ...
  return (
    <aside className="w-64 bg-zinc-950 border-r border-white/[0.04] flex flex-col justify-between h-screen sticky top-0 shrink-0 z-20 overflow-y-auto scrollbar-none">
      <div>
        {/* Brand Logo Header */}
        <div className="h-16 border-b border-white/[0.04] flex items-center px-6 gap-2.5 bg-zinc-950/65 backdrop-blur">
